...
datafiles will not be bundled, and only metadata needed for access will be 
...
The manifest.json file contains four sections:
     ...
     o matches
       ...
       datafile is a part of; a  "bundled" flag which indicates whether or not 
...
search params, including duplicates and non-bundled files".
